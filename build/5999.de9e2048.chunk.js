"use strict";(self.webpackChunkintroduction_to_strapi_api=self.webpackChunkintroduction_to_strapi_api||[]).push([[5999],{64462:(h,M,s)=>{s.d(M,{B:()=>y,D:()=>A,H:()=>U,R:()=>B});var t=s(74081),l=s(10701),d=s(32370),P=s(27997),O=s(73354),g=s(74758),m=s(27875),a=s(87006),e=s(10411),o=s(76827),E=s(61020),c=s(88220),T=s(47289),i=s(72450);const D=(0,i.ZP)(l.k)`
  svg path {
